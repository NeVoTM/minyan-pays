...
- **Git:** Admin bootstrap work is committed as **`9821478`** and matches **`origin/main`** and **`cur/main`** when fetched. Local-only edits: **`PROJECT_STATUS.md`**, **`scripts/embedded-pg-serve.mjs`** (embedded Postgres dev helper — unrelated to web password).
